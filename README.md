...
on a alors branché une seconde carte UCA mais uniquement pour l'envoi de message avec LoRaWAN (le code préfait dans le GitHub de Mr.Ferrero).
...
permis de modéliser notre support en 3D et de l'imprimer à l'aide d'un laser puis à le monter, afin d'avoir un véritable un bon rendu final sur lequel 
intégrer notrecarte UCA et le ventilateur."
